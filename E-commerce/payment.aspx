...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:RadioButton ID="rdoWallet" runat="server"
        GroupName="payment" CssClass="form-check-input" />
    <label class="form-check-label" for="rdoWallet">Wallet</label>
</div>

<div class="form-check">
    <asp:RadioButton ID="rdoCard" runat="server"
        GroupName="payment" CssClass="form-check-input" />
    <label class="form-check-label" for="rdoCard">Credit/Debit Card</label>
</div>

<div class="form-check">
    <asp:RadioButton ID="rdoCOD" runat="server"
        GroupName="payment" CssClass="form-check-input" Checked="true" />
