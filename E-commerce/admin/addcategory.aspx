...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container d-flex justify-content-center align-items-center fade-in" style="height: 80vh;">
        <div class="card shadow p-4 rounded-4" style="width: 100%; max-width: 400px;">
            ...
            <div class="d-grid">
                <asp:Button ID="catbtn" runat="server" Text="Add Category" CssClass="btn btn-primary" OnClick="btnLogin_Click" />
            </div>
            ...
            <div>
                <asp:DropDownList ID="mcatdroplist" runat="server" CssClass="form-select "></asp:DropDownList>
                 <asp:RequiredFieldValidator ID="checkmaincat" runat="server" ControlToValidate="mcatdroplist" CssClass="text-danger" ErrorMessage="Please Select Main Category Name"></asp:RequiredFieldValidator>
            </div>
            <div class="mb-3">
            ...
            <div class="d-grid">
                <asp:Button ID="subcatbtn" runat="server" Text="Add SubCategory" CssClass="btn btn-primary" OnClick="subcatbtn_Click" />
            </div>
